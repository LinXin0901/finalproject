  ...
  render() {
    return (
      <form name="issueAdd" onSubmit={this.handleSubmit}>
        <p><label className = "label_input">User name</label><input type="text" name="name" className="text_field" placeholder="User name"/></p>
        <p><label className = "label_input">Phone number</label><input type="text" name="phoneNum" className="text_field" placeholder="Phone number"/></p>
        <p><label className = "label_input">Password</label><input type="text" name="password" className="text_field" placeholder="Password"/></p>
        <p className="note">Your password must be 8 characters, consisting of numbers (0-9) and letter (a-z or A-Z).</p>
        <p><label className = "label_input">Gender</label><input type="text" name="gender" className="text_field" placeholder="Gender"/></p>
        <p><label className = "label_input">Birthday</label><input type="text" name="birth" className="text_field" placeholder="Birthday"/></p>
        <button className = "label_input">SUBMIT</button>
        <p className="note">By signing up you agree to the our Privacy Policy</p>
        <a id="finish_register" href="search.html">FINISH</a>
      </form>
    );
  }
}
  ...
  render() {
    return (
      <React.Fragment>
        ...
        <a id="finish_register" href="restaurant.html">QUEUE NOW</a>
      </React.Fragment>
    );
  }
}
...
class Search extends React.Component {
  ...
  render() {
    return (
      <React.Fragment>
        <h1>What I want today..</h1>
        <form name="search" onSubmit={this.handleSubmit}>
          <input type="text" name="store" placeholder="Search for Restaurants" />
...
const ele_search = <Search />;

//ReactDOM.render(ele_search, document.getElementById('search_box'));